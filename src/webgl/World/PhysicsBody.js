...
export default class PhysicsBody {
    constructor(RAPIER, scene, world, bodyType, colliderType, dimension, translation, rotation, color) {
        let bodyDesc;
        ...
        if (colliderType === "cube") {
            ...
            bufferGeometry = new SphereBufferGeometry(dimension.radius, 32, 32);
        } else if (colliderType === "cylinder") {
            bufferGeometry = new CylinderBufferGeometry(dimension.radius, dimension.radius, dimension.hh * 2, 32, 32);
        } else if (colliderType === "cone") {
            bufferGeometry = new ConeBufferGeometry(dimension.radius, dimension.hh * 2, 32, 32);
        }
